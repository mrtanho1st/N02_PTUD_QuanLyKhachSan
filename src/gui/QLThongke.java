...
public class QLThongke extends JPanel {
    ...
    switch (loaiThongKe) {
        ...
        case DOANH_THU_THEO_PHONG:
            ...
            setCardTitles("Tổng lượt thuê", "Tổng doanh thu phòng", "Doanh thu phòng cao nhất");
        ...
        case THONG_KE_DICH_VU:
            ...
            setCardTitles("Tổng lượt sử dụng", "Tổng doanh thu DV", "Doanh thu DV cao nhất");
            setFilterLabels("Từ ngày:", "Đến ngày:", "Từ khóa:", "", "", "");
        ...
        case THONG_KE_THEO_NHAN_VIEN:
            ...
            setCardTitles("Tổng nhân sự", "Số hóa đơn đã lập", "Tổng doanh thu");
            setFilterLabels("Từ ngày:", "Đến ngày:", "Từ khóa:", "Ca làm:", "Tháng:", "Vị trí:");
