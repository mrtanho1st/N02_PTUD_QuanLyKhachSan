...
public class GiaoDienKhuyenMai extends JFrame {
    ...
    private JPanel createFilterPanel() {
        ...
        JLabel lbSearch = new JLabel("Tìm khuyến mãi:");
        ...
        JComboBox<String> cbFilter = new JComboBox<String>(new String[] {
                "Mã KM", "Tên chương trình", "Loại", "Trạng thái"
        });
    ...
    private JPanel createFormPanel() {
        ...
        addFormRow(form, gbc, "Mã khuyến mãi", createInputField(""));
        addFormRow(form, gbc, "Tên chương trình", createInputField(""));
        addFormRow(form, gbc, "Loại khuyến mãi", new JComboBox<String>(new String[] {
                "Giảm theo %", "Giảm số tiền", "Combo", "Dịch vụ tặng kèm"
        }));
        addFormRow(form, gbc, "Giá trị", createInputField("0"));
        addFormRow(form, gbc, "Ngày bắt đầu", createInputField("dd/MM/yyyy"));
        addFormRow(form, gbc, "Ngày kết thúc", createInputField("dd/MM/yyyy"));
        addFormRow(form, gbc, "Điều kiện áp dụng", createInputField(""));
        ...
        moTaScroll.setPreferredSize(new Dimension(280, 90));
    ...
    private JPanel createTablePanel() {
        ...
        tableModel = new DefaultTableModel(
                new Object[] { "Mã KM", "Tên chương trình", "Loại", "Giá trị", "Bắt đầu", "Kết thúc", "Trạng thái" },
                0) {
            private static final long serialVersionUID = 1L;
    ...
    private void seedData() {
        tableModel.addRow(new Object[] { "KM001", "Giảm giá cuối tuần", "Giảm theo %", "10%", "01/04/2026",
                "30/04/2026", "Sắp diễn ra" });
        tableModel.addRow(new Object[] { "KM002", "Combo Spa + Buffet", "Combo", "350,000", "25/03/2026", "20/04/2026",
                "Đang diễn ra" });
        tableModel.addRow(new Object[] { "KM003", "Tặng nước welcome", "Dịch vụ tặng kèm", "Miễn phí", "01/03/2026",
                "31/03/2026", "Đã kết thúc" });
        tableModel.addRow(new Object[] { "KM004", "Giảm trực tiếp hóa đơn", "Giảm số tiền", "200,000", "15/03/2026",
                "15/04/2026", "Đang diễn ra" });
    }
