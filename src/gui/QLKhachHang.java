...
public class QLKhachHang extends JFrame {
    ...
    private JPanel createFilterPanel() {
        ...
        JComboBox<String> cbFilter = new JComboBox<String>(new String[] { "Mã KH", "Họ tên", "SĐT", "CCCD" });
    ...
    private JPanel createTablePanel() {
        ...
        tableModel = new DefaultTableModel(
                new Object[] { "Mã KH", "Họ tên", "SĐT", "Email", "CCCD" }, 0) {
            private static final long serialVersionUID = 1L;
    ...
    private void seedData() {
        tableModel
                .addRow(new Object[] { "KH001", "Nguyễn Văn An", "0901234567", "an.nguyen@gmail.com", "079204001111" });
        tableModel
                .addRow(new Object[] { "KH002", "Trần Thị Bình", "0912345678", "binh.tran@gmail.com", "079204002222" });
        tableModel.addRow(new Object[] { "KH003", "Lê Hoàng Long", "0933456789", "long.le@gmail.com", "079204003333" });
        tableModel.addRow(
                new Object[] { "KH004", "Phạm Minh Khoa", "0945566778", "khoa.pham@gmail.com", "079204004444" });
        tableModel.addRow(new Object[] { "KH005", "Đỗ Gia Hân", "0967788990", "han.do@gmail.com", "079204005555" });
    }
