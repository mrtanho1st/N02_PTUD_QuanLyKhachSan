...
public class QLTaiKhoan {
    ...
    private static JPanel createFilterPanel() {
        ...
        javax.swing.JLabel lbSearch = new javax.swing.JLabel("Tìm tài khoản:");
        ...
        JComboBox<String> cbFilter = new JComboBox<String>(new String[] {
                "Mã tài khoản", "Nhân viên", "Tên đăng nhập", "Vai trò"
        });
    ...
    private static JPanel createFormPanel() {
        ...
        javax.swing.JLabel title = new javax.swing.JLabel("Thông tin tài khoản");
        ...
        addFormRow(form, gbc, "Mã tài khoản", createInputField(""));
        addFormRow(form, gbc, "Nhân viên", createInputField(""));
        addFormRow(form, gbc, "Tên đăng nhập", createInputField(""));
        addFormRow(form, gbc, "Mật khẩu", createInputField(""));
        addFormRow(form, gbc, "Vai trò", new JComboBox<String>(new String[] {
                "Nhân viên lễ tân", "Nhân viên quản lý"
        }));
    ...
    private static JPanel createTablePanel() {
        ...
        javax.swing.JLabel title = new javax.swing.JLabel("Danh sách tài khoản");
        title.setFont(new Font("Segoe UI", Font.BOLD, 22));
        title.setForeground(TEXT);

        DefaultTableModel tableModel = new DefaultTableModel(
                new Object[] { "Mã TK", "Nhân viên", "Tên đăng nhập", "Vai trò" }, 0) {
    ...
    private static JPanel createActionPanel() {
        ...
        actions.add(createPrimaryButton("Tạo tài khoản", 140, 38));
        actions.add(createPrimaryButton("Cập nhật", 120, 38));
        actions.add(createDangerButton("Xoá", 110, 38));
    ...
    private static void seedData(DefaultTableModel tableModel) {
        tableModel.addRow(new Object[] { "TK001", "Quân Quấn Quýt", "giaquan", "Nhân viên quản lý" });
        tableModel.addRow(new Object[] { "TK002", "Tân Thông Thả", "minhtan", "Nhân viên quản lý" });
        tableModel.addRow(new Object[] { "TK003", "Tường Thông Thái", "dotuong", "Nhân viên lễ tân" });
        tableModel.addRow(new Object[] { "TK004", "Thư Tưng Tửng", "thanhthu", "Nhân viên lễ tân" });
    }
