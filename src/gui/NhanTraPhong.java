...
public class NhanTraPhong extends JFrame {
    ...
    private void seedData() {
        String sql = "SELECT MaDon, KhachHang, SoPhong, NhanPhong, TraPhong, NhanVien, TrangThai "
                + "FROM dbo.NhanTraPhong ORDER BY MaDon";
        try {
            ...
            try (PreparedStatement statement = connection.prepareStatement(sql);
                ...
                while (resultSet.next()) {
                    tableModel.addRow(new Object[] {
                            ...
                            resultSet.getString("NhanPhong"),
                            resultSet.getString("TraPhong"),
