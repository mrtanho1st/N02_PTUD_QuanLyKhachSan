...
('P105', N'Superior', 3,  700000,  N'Trống'),
...
('P110', N'Suite',    4, 1550000,  N'Trống'),
('P111', N'Standard', 2,  520000,  N'Trống'),
('P112', N'Superior', 2,  680000,  N'Trống'),
('P113', N'Deluxe',   2,  820000,  N'Đang sử dụng'),
('P114', N'Deluxe',   3,  880000,  N'Đang sử dụng'),
('P115', N'Suite',    4, 1600000,  N'Đang sử dụng'),
('P116', N'Standard', 2,  540000,  N'Đang sử dụng'),
('P117', N'Superior', 3,  720000,  N'Bảo trì'),
('P118', N'Deluxe',   2,  870000,  N'Đang sử dụng'),
